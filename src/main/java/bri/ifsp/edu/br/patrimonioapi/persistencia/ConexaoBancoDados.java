...
public class ConexaoBancoDados {
    ...
    private EntityManagerFactory getFactory() {
        ...
        propriedades.put("hibernate.connection.url", "jdbc:mysql://localhost:3306/patrimonio");
        ...
        propriedades.put("hibernate.default_schema", "patrimonio");
        return Persistence.createEntityManagerFactory("patrimonio", propriedades);
    }
}
